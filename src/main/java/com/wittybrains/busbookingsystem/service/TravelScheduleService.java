...
public class TravelScheduleService {
	...
	public boolean createSchedule(TravelScheduleDTO travelScheduleDTO) throws ParseException {
	    ...
	    travelSchedule.setSeatBooked(travelScheduleDTO.getSeatBooked());
	    ...
	    int seatBooked = travelSchedule.getSeatBooked();

	    if (totalSeats < seatBooked) {
	        throw new IllegalArgumentException("Number of seats booked cannot be greater than total number of seats");
	    }
