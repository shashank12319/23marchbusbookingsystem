...
public class TravelScheduleController {
	...
	@PostMapping
	public ResponseEntity<String> createTravelSchedule(@RequestBody TravelScheduleDTO travelScheduleDTO) throws ParseException {
	    boolean result = travelScheduleService.createSchedule(travelScheduleDTO);

	    if (result) {
	        return ResponseEntity.ok("Travel schedule created successfully");
	    } else {
